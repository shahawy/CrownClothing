...
ReactGA.send({ hitType: "pageview", page: window.location.pathname, title: "Displayed Authentication Page"});
ReactGA.send({ hitType: "pageview", page: window.location.pathname, title: "Displayed Checkout Page"});
