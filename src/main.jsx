...
ReactGA.send({ hitType: "pageview", page: "/authentication", title: "Showed Authentication Page"});
ReactGA.send({ hitType: "pageview", page: "/checkout", title: "Showed Checkout Page"});
